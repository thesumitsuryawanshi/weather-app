...
class MainActivity : AppCompatActivity() {
    ...
    val API: String = "06c921750b9a82d8f5d1294e1586276f" //  API key from [ https://openweathermap.org/api ]
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                /* Putting extracted data into our views */
                findViewById<TextView>(R.id.address).text = address
                findViewById<TextView>(R.id.updated_at).text =  updatedAtText
                findViewById<TextView>(R.id.status).text = weatherDescription.capitalize()
                findViewById<TextView>(R.id.temperature_value).text = temp
                findViewById<TextView>(R.id.sunrise_value).text = SimpleDateFormat("hh:mm a", Locale.ENGLISH).format(Date(sunrise*1000))
                findViewById<TextView>(R.id.sunset_value).text = SimpleDateFormat("hh:mm a", Locale.ENGLISH).format(Date(sunset*1000))
